const CACHE='hatchery-island-v1';
const SHELL=['./','index.html','styles.css','game.js','manifest.webmanifest','assets/data/sprites.json','assets/data/game-data.json','assets/images/app-icon-192.png','assets/images/archive-screenshot.jpeg'];
