...
-- Image = gamelua.ui.Image

ScallableButton.TWEEN_TYPE = { 	LINEAR = "LINEAR", EASE_CUBIC_IN="EASE_CUBIC_IN", EASE_CUBIC_OUT="EASE_CUBIC_OUT", EASE_CUBIC_IN_OUT="EASE_CUBIC_IN_OUT"}
ScallableButton.STATE = { 	IDLE = "IDLE", SCALING_IN="SCALING_IN", FULLY_SCALED="FULLY_SCALED", SCALING_OUT="SCALING_OUT"}
...
function ScallableButton:setup(startScale, endScale, animationTime, animationType)
	self.scaleX = startScale
	self.scaleY = startScale
